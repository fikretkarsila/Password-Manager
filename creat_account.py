...
"")
        ...
        self.generate_password.setGeometry(QtCore.QRect(340, 260, 105, 51))
...
if __name__ == "__main__":
    ...
    MainWindow_create = QtWidgets.QMainWindow()
    ui = Ui_MainWindow_create()
    ui.setupUi(MainWindow_create)
    MainWindow_create.show()
    sys.exit(app.exec())
